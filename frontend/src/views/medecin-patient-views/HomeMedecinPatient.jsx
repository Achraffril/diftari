        ...
        <div className=" min-h-screen">
          ...
          <main className="-mt-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Link to={`/medecin-patient/${dossier.id}/profile`} className="transform transition-transform hover:scale-105">
              ...
              <Link to={`/medecin-patient/${dossier.id}/examen-systematique`} className="transform transition-transform hover:scale-105">
                <HomeCardsMedPatient title="Examens Systematiques" desc="This section contains systematic examinations data."/>
              </Link>
              {/* COURBES DE CROISSANCE */}
              <Link to={`/medecin-patient/${dossier.id}/vaccination`} className="transform transition-transform hover:scale-105">
              ...
              <Link to={`/medecin-patient/${dossier.id}/supplementation`} className="transform transition-transform hover:scale-105">
                <HomeCardsMedPatient title="Supplementation en Vitamines" desc="This section contains vitamin supplementation information."/>
              </Link>
                <Link
                to={`/medecin-patient/${dossier.id}/consultation`}
                className="transform transition-transform hover:scale-105"
              >
                <HomeCardsMedPatient
                  title="Consultation"
                  desc="This section contains consultation information."
                />
            </Link>
            </div>
          </main>
