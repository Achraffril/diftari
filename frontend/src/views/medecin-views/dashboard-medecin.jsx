...
import DashboardMedcinCard from "../../componants/medecin/dashboardComponants/Dashboard-medecin";
import LineChart from "../../componants/medecin/dashboardComponants/Statistice-line";
import DoughnutChart from "../../componants/medecin/dashboardComponants/Statistice-donat";
...
<div className=" flex items-center justify-center  ">
      <div className="container mx-auto">
        <h1 className="text-3xl font-semibold mb-5 text-center text-secondary-color">{language === 'FR'?"Doctor Dashboard" : 'لوحة تحكم الطبيب'}</h1>
        ...
        <div>
            <div className="mb-5">
              <DashboardMedcinCard titre={language == 'FR'?"Patient Statistics" : 'إحصائيات المرضى'} info={language == 'FR'?"Total Patients: 100" : 'إجمالي المرضى: 100'} info2={language == 'FR'?"Patients Today: 10" : 'المرضى اليوم: 10'} align={language == 'FR'?"left" : 'right'}/>
            </div>
            <div>
                <DashboardMedcinCard titre={language == 'FR'?"Appointments" : 'تعيينات'} info={language == 'FR'?"John Doe - 10:00 AM" : ' صباحًا 10:00 - John Doe'} info2={language == 'FR'?"Jane Smith - 11:00 AM" : 'صباحًا 11:00 - Jane Smith'} align={language == 'FR'?"left" : 'right'}/>
            </div>
          </div>
  
    
     {/* Notifications */}
          <DashboardMedcinCard titre='Notifications' info='New Appointment Request' info2='Payment Received' />
          ...
          {/* <div class="antialiased bg-gray-100 w-full min-h-screen text-slate-300 relative py-4">
    <div class="grid grid-cols-12 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
        ...
        <div id="content" class="bg-white/10 col-span-9 rounded-lg p-6">
            <div id="24h">
                <h1 class="font-bold py-4 ">Statistiques des dernières 24 heures</h1>
                <div id="stats" class="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="bg-white text-gray-700 p-6 rounded-lg">
                        <div class="flex flex-row space-x-4 items-center">
                            ...
                            <div>
                                <p class="text-indigo-300 text-sm font-medium uppercase leading-4">Patients</p>
                    ...
                    <div class="bg-white p-6 rounded-lg">
                        <div class="flex flex-row space-x-4 items-center">
                            ...
                            <div>
                                <p class="text-blue-300 text-sm font-medium uppercase leading-4">Les raports</p>
                                <p class="text-gray-800 font-bold text-2xl inline-flex items-center space-x-2">
                                    <span>12</span>
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div id="last-incomes">
                ...
                <div id="stats" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <div class="bg-white to-white/5 rounded-lg">
